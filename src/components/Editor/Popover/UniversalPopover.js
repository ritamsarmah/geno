        ...
        return (
            <div style={{ margin: "10px 0" }}>
                <div id="bottomButtons">
                    ...
                    <input className="conditionalButton" type="button" style={{ marginLeft: "8px" }} value="Train & Create" onClick={this.createFunctionCommand} disabled={this.isCommandValid()}></input>
                </div> 
            </div>
        );
    }
