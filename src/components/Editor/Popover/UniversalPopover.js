...
export default class UniversalPopover extends Popover {
  ...
  toggleContextAttribute(attribute) {
    ...
    var contextType =
      attribute.length === 0 ? ContextType.Element : ContextType.Attribute;
    ...
    this.setState((prevState) => ({
      command: {
        ...
        contextInfo: {
          ...prevState.command.contextInfo,
          type:
            prevState.command.contextInfo.type === ContextType.Text
              ? ContextType.Text
              : ContextType.Element,
          selector: "*",
          allAttributes: [],
      ...
      <div style={{ margin: "10px 0" }}>
        <div id="bottomButtons">
          ...
          <input
            ...
            value="Train & Create"
            onClick={this.createFunctionCommand}
