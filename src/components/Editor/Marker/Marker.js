...
export default class Marker extends Component {
    ...
    onClick() {
        if (!this.state.filled) {
            ...
            markerMap[this.props.triggerFn] = true;
    ...
    render() {
        return (
            <Tippy content={<Popover triggerFn={this.props.triggerFn} params={this.props.params}/>} arrow={true} trigger="click" placement="right" theme="light-border" animation="scale" inertia={true} interactive={true}>
